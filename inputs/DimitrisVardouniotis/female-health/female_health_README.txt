Female Health Data Export

The Female Health category of your data export includes all of the content you have added to the Fitbit female health tracker. This includes your settings, symptoms, menstrual cycles and birth control.

Files Included:
----------

female_health_birth_control.csv
...
female_health_settings.csv

These are the settings that you enter while using female health tracking
